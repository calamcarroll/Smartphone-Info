...
<?php
  ...
  if(isset($_POST['btnsave']))
  {
    ...
    else
    {
      ...
      $valid_extensions = array('jpeg', 'jpg', 'png', 'gif'); // the valid image extensions that are aloud 
    ...
    if(!isset($errMSG))
    {
      $stmt = $auth_user->runQuery('INSERT INTO phones(userMake,userModel,userDesc,userPrice, user_id, userPic) VALUES(:uMake, :uModel, :udesc, :uprice, :uid, :upic )');
...
<?php
  ...
  ?>   
     <h3>Please enter you add details here!</h3>
     <br>
